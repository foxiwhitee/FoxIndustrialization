...
public class GuiQuantumMetalFormer extends GuiQuantumMachine {
    private final TileQuantumMetalFormer tile;

    public GuiQuantumMetalFormer(ContainerQuantumMachine container) {
        super(container);
        tile = (TileQuantumMetalFormer) container.getTileEntity();
    }
    ...
    protected String getBackground() {
        return "gui/guiQuantumMetalFormer.png";
    }
}
